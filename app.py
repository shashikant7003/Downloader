...
def download():
    ...
    ydl_opts = {
        ...
        # 🚀 Latest Bot Bypass: YouTube ko lagega request iPhone App se aa rahi hai
        'extractor_args': {
            'youtube': {
        ...
        'no_warnings': True,
        'quiet': False  # Logs dikhne do taaki sahi error pata chale
    }
    ...
    try:
        ...
        # Pura clear error message dikhane ke liye
